...
**1. Get to know RStudio.**
- Open RStudio and identify each of the four main panels.

**2. Create your first RStudio project.**
- Use the RStudio interface to start a new project in a new directory.

**3. Install and load a package.**
- Install the `dplyr` and `tidyverse` packages and load them using `library()`. 
